...
class _UnitTestParams extends NetworkParameters {
  ...
  Block get genesisBlock {
    if(_genesis == null) {
      Block genesis = NetworkParameters._createGenesis(this)
        ...
        .._difficultyTarget = Block.EASIEST_DIFFICULTY_TARGET
        ..solve();
      _genesis = genesis;
    }
    return _genesis;
  ...
  BigInteger get proofOfWorkLimit => new BigInteger("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16);
}