...
class Address {
  ...
  Address(String base58address) {
    ...
    Base58CheckPayload payload =
        new Base58CheckDecoder(BASE58_ALPHABET, crypto.singleDigest).convert(base58address);
    if (payload.payload.length != 20)
      throw new FormatException("The Base58 address should be exactly 25 bytes long: a 21-byte "
   ...
   */
  bool isPayToPubkeyHashAddress([NetworkParameters params = NetworkParameters.MAIN_NET]) =>
