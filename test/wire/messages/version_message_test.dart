...
void _testDecode() {
    ...
    VersionMessage ver = new Message.fromPayload("version", CryptoUtils.hexToBytes("71110100000000000000000048e5e95000000000000000000000000000000000000000000000ffff7f000001479d000000000000000000000000000000000000ffff7f000001479d0000000000000000172f426974436f696e4a3a302e372d534e415053484f542f0004000000")
        , params: params);
    expect(ver.relayBeforeFilter, isFalse);
    expect(ver.lastHeight, equals(1024));
    expect(ver.subVer, equals("/BitCoinJ:0.7-SNAPSHOT/"));
    
    ver = new Message.fromPayload("version", CryptoUtils.hexToBytes("71110100000000000000000048e5e95000000000000000000000000000000000000000000000ffff7f000001479d000000000000000000000000000000000000ffff7f000001479d0000000000000000172f426974436f696e4a3a302e372d534e415053484f542f00040000")
        , params: params);
    expect(ver.relayBeforeFilter, isTrue);
    expect(ver.lastHeight, equals(1024));
    expect(ver.subVer, equals("/BitCoinJ:0.7-SNAPSHOT/"));
    
    ver = new Message.fromPayload("version", CryptoUtils.hexToBytes("71110100000000000000000048e5e95000000000000000000000000000000000000000000000ffff7f000001479d000000000000000000000000000000000000ffff7f000001479d0000000000000000172f426974436f696e4a3a302e372d534e415053484f542f")
        , params: params);
    expect(ver.relayBeforeFilter, isTrue);
    expect(ver.lastHeight, equals(0));
    expect(ver.subVer, equals("/BitCoinJ:0.7-SNAPSHOT/"));
    
    ver = new Message.fromPayload("version", CryptoUtils.hexToBytes("71110100000000000000000048e5e95000000000000000000000000000000000000000000000ffff7f000001479d000000000000000000000000000000000000ffff7f000001479d0000000000000000")
        , params: params);
    expect(ver.relayBeforeFilter, isTrue);
    expect(ver.lastHeight, equals(0));
