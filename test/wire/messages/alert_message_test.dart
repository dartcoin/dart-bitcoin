...
Uint8List _TEST_KEY_PRIV = CryptoUtils.hexToBytes("6421e091445ade4b24658e96aa60959ce800d8ea9e7bd8613335aa65ba8d840b");
NetworkParameters _params;

void _setUp() {
  KeyPair key = new KeyPair.private(_TEST_KEY_PRIV);
...
class _AlertMessageTestParams implements NetworkParameters {
  ...
  @override
  Uint8List get alertSigningKey => new KeyPair.private(_TEST_KEY_PRIV).publicKey;
...
void _deserialize() {
  ...
  // TODO [bitcoinj]: This does not check the subVer or set fields. Support proper version matching.
  Uint8List payload = CryptoUtils.hexToBytes("");
