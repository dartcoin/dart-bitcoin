...
void main() {
  group("wire.BloomFilter", () {
    ...
    test("insertSerialize", () {
      ...
      expect(CryptoUtils.bytesToHex(filter.bitcoinSerializedBytes(0)), equals("03614e9b050000000000000001"));
    });
    ...
    test("insertSerializeWithTweak", () {
      ...
      // Value generated by the reference client
      expect(CryptoUtils.bytesToHex(filter.bitcoinSerializedBytes(0)), equals("03ce4299050000000100008002"));
    });
