...
void main() {
  group("wire.BloomFilter", () {
    test("insertSerialize", () {
      ...
      expect(filter.contains(CryptoUtils.hexToBytes("99108ad8ed9bb6274d3980bab5a85c048f0950c8")),
          isTrue);
      // One bit different in first byte
      expect(filter.contains(CryptoUtils.hexToBytes("19108ad8ed9bb6274d3980bab5a85c048f0950c8")),
          isFalse);

      filter.insert(CryptoUtils.hexToBytes("b5a2c786d9ef4658287ced5914b37a1b4aa32eee"));
      expect(filter.contains(CryptoUtils.hexToBytes("b5a2c786d9ef4658287ced5914b37a1b4aa32eee")),
          isTrue);

      filter.insert(CryptoUtils.hexToBytes("b9300670b4c5366e95b2699e8b18bc75e5f729c5"));
      expect(filter.contains(CryptoUtils.hexToBytes("b9300670b4c5366e95b2699e8b18bc75e5f729c5")),
          isTrue);

      // Value generated by the reference client
      expect(CryptoUtils.bytesToHex(filter.bitcoinSerializedBytes(0)),
          equals("03614e9b050000000000000001"));
    });

    test("insertSerializeWithTweak", () {
      ...
      // Value generated by the reference client
      expect(CryptoUtils.bytesToHex(filter.bitcoinSerializedBytes(0)),
          equals("03ce4299050000000100008002"));
    });
