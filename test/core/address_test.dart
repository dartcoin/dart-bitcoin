...
void _stringification() {
  ...
  Address a = new Address(Utils.hexToBytes("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc"), _testParams);
  ...
  Address b = new Address(Utils.hexToBytes("4a22c3c4cbb31e4d03b15550636762bda0baf85a"), _mainParams);
...
void _decoding() {
  ...
  expect(Utils.bytesToHex(a.hash160), equals("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc"));

  Address b = new Address("17kzeh4N8g49GFvdDzSf8PjaPfyoD1MndL", _mainParams);
  expect(Utils.bytesToHex(b.hash160), equals("4a22c3c4cbb31e4d03b15550636762bda0baf85a"));
}
